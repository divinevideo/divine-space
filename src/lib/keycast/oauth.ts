 ...
 * Handles authorization URL generation, token exchange, and PKCE
 */
 ...
 */
function derivePublicKeyFromNsec(nsec: string): string {
...
export class KeycastOAuth {
  ...
  async getAuthorizationUrl(options: {
    ...
    if (options.nsec) {
      const pubkey = derivePublicKeyFromNsec(options.nsec);
